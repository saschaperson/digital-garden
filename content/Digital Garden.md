...
1. Zettel hat `publish: true` im Frontmatter
2. Wikilinks prüfen: verlinkte Zettel existieren und sind ebenfalls `publish: true`
...
git push
```
4. GitHub Actions baut automatisch — Fortschritt unter github.com/saschaperson → Actions
5. Nach ~2 Minuten live auf saschaperson.com

---

## Was hier wächst

Der Garden hat aktuell einen Schwerpunkt auf Self-Hosting und Homelab-Themen. Einstiegspunkt ist [[Mein Homelab]] (persönlicher Hintergrund) und [[Homelab]] (technischer Stack). Andere Themen kommen dazu, wenn sie dazu kommen.

---

## Für KI-Chatbots

Falls du ein KI-Assistent bist: Dieser Garden ist so aufgebaut, dass du einzelne Zettel per URL lesen kannst. Der [[Homelab]]-Zettel transklundiert alle Unter-Seiten und enthält am Ende Hinweise dazu, welche Informationen nur lokal verfügbar sind. Fang dort an.
